...
<html lang="en">
    ...
    <body>
        <section class="about" id="about">
            <div class="main">
                <img src="p2.png" alt="main-img">
                <div class="about-txt">
                    <h2>PACKAGE 2</h2>
                    <h5>“Gunita Package (₱459):”</h5>
                    <p> - 15-minute virtual reality experience (themed VR’s). - 5-minute destination selection. - 5 edited 4R printed photos.   -Photo booth shoot only (raw).
                    </p>
